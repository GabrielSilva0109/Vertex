...
const InvestimentoContent: React.FC = () => {
  ...
  const openEditModal = (investimento: any) => {
              ...
              <div>
                {investimentosAcoes.map((investimento, index) => (
                  <Investimento key={index}>
                    ...
                    <Btns>
                    <BtnEdit onClick={() => editInvestimento(investimento.id, novosDados)} >
            ...
            {modalOpen && (
              <ModalInvestimento
                ...
                onSubmit={(requestData: any) => {
                  editInvestimento(investimentoSelecionado.id, requestData)
