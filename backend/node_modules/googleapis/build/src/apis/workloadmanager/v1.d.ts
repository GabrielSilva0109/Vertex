...
export declare namespace workloadmanager_v1 {
    ...
    export class Resource$Projects$Locations$Workloadprofiles {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Workloadprofiles$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Projects$Locations$Workloadprofiles$Get, options?: MethodOptions): GaxiosPromise<Schema$WorkloadProfile>;
        get(params: Params$Resource$Projects$Locations$Workloadprofiles$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Workloadprofiles$Get, options: MethodOptions | BodyResponseCallback<Schema$WorkloadProfile>, callback: BodyResponseCallback<Schema$WorkloadProfile>): void;
        get(params: Params$Resource$Projects$Locations$Workloadprofiles$Get, callback: BodyResponseCallback<Schema$WorkloadProfile>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Workloadprofiles$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Projects$Locations$Workloadprofiles$List, options?: MethodOptions): GaxiosPromise<Schema$ListWorkloadProfilesResponse>;
        list(params: Params$Resource$Projects$Locations$Workloadprofiles$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Workloadprofiles$List, options: MethodOptions | BodyResponseCallback<Schema$ListWorkloadProfilesResponse>, callback: BodyResponseCallback<Schema$ListWorkloadProfilesResponse>): void;
        list(params: Params$Resource$Projects$Locations$Workloadprofiles$List, callback: BodyResponseCallback<Schema$ListWorkloadProfilesResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListWorkloadProfilesResponse>): void;
    }
    export interface Params$Resource$Projects$Locations$Workloadprofiles$Get extends StandardParameters {
        /**
         * Required. Name of the resource
         */
        name?: string;
    }
    export interface Params$Resource$Projects$Locations$Workloadprofiles$List extends StandardParameters {
        /**
